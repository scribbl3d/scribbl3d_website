    ...
    switch (step) {
      case 0: // Introduction
        return (
          <>
            <CardHeader>
              <CardTitle>Small Batch Manufacturing Request</CardTitle>
              <CardDescription>
                Welcome! This form will guide you through specifying your
                manufacturing needs. Please have your design files ready. The
                process takes about 5-10 minutes to complete.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>Design files (STL, OBJ, or similar formats)</li>
        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Start by uploading your design files and specifying the quantity
                needed.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="designFile">Design Files (Max 10MB)</Label>
                <Input
                  id="designFile"
                  type="file"
              ...
              <div className="space-y-2">
                <Label htmlFor="quantity">Number of Pieces Required</Label>
                <Input
                  id="quantity"
                  name="quantity"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="requirements">Particular Requirements</Label>
                <Textarea
                  id="requirements"
                  name="requirements"
        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Select your preferred 3D printing technology and material.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      {formData.material === "ABS" && (
                        <>
                          <SelectItem value="ABS">ABS</SelectItem>
                          <SelectItem value="ABS GF">ABS GF</SelectItem>
                          <SelectItem value="ABS CF">ABS CF</SelectItem>
                          <SelectItem value="ABS FR">ABS FR</SelectItem>
                        </>
                      )}
                      ...
                      {formData.material === "PETG" && (
                        <>
                          <SelectItem value="PETG">PETG</SelectItem>
                          <SelectItem value="PETG GF">PETG GF</SelectItem>
                          <SelectItem value="PETG CF">PETG CF</SelectItem>
                          <SelectItem value="PETG FR">PETG FR</SelectItem>
                        </>
                      )}
                      {formData.material === "PA" && (
                        <>
                          <SelectItem value="Nylon 6">Nylon 6</SelectItem>
                          <SelectItem value="Nylon 66">Nylon 66</SelectItem>
          ...
          <>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                {errors.productColor && (
                  <p className="text-sm text-red-500">{errors.productColor}</p>
                )}
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {formData.requirements && (
                    <p>Requirements: {formData.requirements}</p>
                  )}
                </div>
                <div>
                  <h3 className="font-medium">Technology and Material</h3>
                ...
                <div>
                  ...
                  <p>Product Color: {formData.productColor}</p>
        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Your small batch manufacturing request has been submitted
                successfully.
              </CardDescription>
            </CardHeader>
            <CardContent>
