...
export default function NewFilamentPage() {
    ...
    const [variants, setVariants] = useState([
        { diameter: "", spoolWeight: "", price: "", originalPrice: "", inStock: true, isDefault: true },
    ]);

    const [specifications, setSpecifications] = useState([
        { category: "Printing Parameters", key: "", value: "" },
    ]);

    const [downloads, setDownloads] = useState<Array<{ title: string; description: string; fileUrl: string }>>([]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(err.error || "Failed to create filament");
            }
            ...
            <form onSubmit={handleSubmit}>
                <div className="bg-white border-b sticky top-0 z-20 shadow-sm">
                    <div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-lg sm:text-xl font-bold">Add New Filament</h1>
                        </div>
                        <button
                            type="submit"
                            disabled={loading}
                ...
                <div className="bg-white rounded-lg border p-6 mb-6">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-xl font-bold">Variants (Diameter/Weight/Price)</h2>
                        <button type="button" onClick={addVariant} className="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 flex items-center gap-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {formData.features.map((f, i) => (
                                <span key={i} className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm flex items-center gap-2">
                                    {f}
                                    <button type="button" onClick={() => removeFromArray("features", i)} className="hover:text-blue-900">
                                        <X className="w-3 h-3" />
                                    </button>
                                </span>
                            ))}
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex gap-2 mb-2">
                            <input
                                ...
                                onKeyPress={(e) => e.key === "Enter" && (e.preventDefault(), addToArray("applications", newApplication))}
                                className="flex-1 border rounded-lg px-3 py-2"
                        ...
                        <div className="flex flex-wrap gap-2">
                            {formData.applications.map((a, i) => (
                                <span key={i} className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm flex items-center gap-2">
                                    {a}
                                    <button type="button" onClick={() => removeFromArray("applications", i)} className="hover:text-green-900">
                                        <X className="w-3 h-3" />
                                    </button>
                                </span>
                            ))}
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 mb-2">
                            <input
                                ...
                                onKeyPress={(e) => e.key === "Enter" && (e.preventDefault(), addToArray("compatibility", newCompatibility))}
                                className="flex-1 border rounded-lg px-3 py-2"
                                placeholder="Add compatible printer"
                            />
                        ...
                        <div className="flex flex-wrap gap-2">
                            {formData.compatibility.map((c, i) => (
                                <span key={i} className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm flex items-center gap-2">
                                    {c}
                                    <button type="button" onClick={() => removeFromArray("compatibility", i)} className="hover:text-purple-900">
                                        <X className="w-3 h-3" />
                                    </button>
                                </span>
                            ))}
                ...
                <div className="bg-white rounded-lg border p-6 mb-6">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button type="button" onClick={addSpecification} className="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 flex items-center gap-2">
                            <Plus className="w-4 h-4" />
                            Add Spec
                        </button>
                    </div>
                ...
                <div className="bg-white rounded-lg border p-6 mb-6">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-xl font-bold">Downloads (TDS, MSDS, etc.)</h2>
                        <button type="button" onClick={addDownload} className="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 flex items-center gap-2">
                            <Plus className="w-4 h-4" />
                            Add Download
                        </button>
                    </div>
