...
const missionContent = {
  mainMission:
    "To empower creators by providing exceptional 3D printing solutions—grounded in innovation, guided by integrity, and driven by a relentless passion for quality.",
  values: [
    {
    ...
    <div className="bg-white py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-xl">{missionContent.mainMission}</p>
        </div>
