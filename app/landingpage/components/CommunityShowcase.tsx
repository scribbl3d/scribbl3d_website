...
export default function CommunityShowcase({ images }: CommunityShowcaseProps) {
    ...
    return (
        <section className="w-full bg-white pt-16 pb-8 overflow-hidden">
            ...
            {/* Marquee — full width, overflows past container */}
            <div className="group relative">
                <div className="flex w-max animate-marquee group-hover:[animation-play-state:paused]">
                    {/* Render images twice for seamless loop */}
                    {[...images, ...images].map((img, index) => {
                        const card = (
                            <div className="flex-shrink-0 w-[200px] sm:w-[230px] lg:w-[260px] aspect-square rounded-2xl overflow-hidden bg-gray-200 cursor-pointer">
                                <img
                                    src={img.imageUrl}
