...
export default function ProductPage({
  ...
  const handleAddToCart = async () => {
    ...
    const effectiveColor = colors.length === 1 ? colors[0].id : selectedColor;
    ...
    try {
      ...
      await addToCart({
        ...
        images,
        isPrebuilt: true,
        productSizeId: effectiveSize,
        productColorId: effectiveColor,
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            {sizes.length > 0 && (
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  {/* Standard Sizes */}
                  {sizes.filter((size) => size.sizeType === "standard").length >
                    0 && (
                    <div className="space-y-2">
                      ...
                      >
                        {sizes
                          .filter((size) => size.sizeType === "standard")
                          .map((size) => (
                            <Label
                              key={size.id}
                  ...
                  {/* Fractional Sizes */}
                  {sizes.filter((size) => size.sizeType === "fractional")
                    .length > 0 && (
                    <div className="space-y-2">
                      <Label className="text-sm text-gray-500">
                        Fractional Sizes
                      ...
                      >
                        {sizes
                          .filter((size) => size.sizeType === "fractional")
                          .map((size) => (
                            <Label
                              key={size.id}
                              className={`relative px-4 py-2 border rounded-md cursor-pointer ${
                  ...
                  {/* Custom Sizes */}
                  {sizes.filter((size) => size.sizeType === "custom").length >
                    0 && (
                    <div className="space-y-2">
                      <Label className="text-sm text-gray-500">
                        Custom Sizes
                      ...
                      >
                        {sizes
                          .filter((size) => size.sizeType === "custom")
                          .map((size) => (
                            <Label
                              key={size.id}
                              className={`relative px-4 py-2 border rounded-md cursor-pointer ${
