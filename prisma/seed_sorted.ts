const prebuiltProducts = [
  // ===================== Cosplay =====================
  {
    ...
    sizeData: [{ name: "R", price: 499, originalPrice: 999 }],
    features: [
...

  {
    ...
    sizeData: [{ name: "One Size", price: 599, originalPrice: 999 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "One Size", price: 399, originalPrice: 699 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [
      { name: "R", price: 299, originalPrice: 399, sizeType: "standard" },
    ],
  },
  {
    name: "Moon Lamp",
    ...
    sizeData: [
      { name: "R", price: 499, originalPrice: 599, sizeType: "standard" },
    ],
  },
  {
    name: "FengShui Frog",
    ...
    sizeData: [
      { name: "S", price: 199, originalPrice: 499, sizeType: "standard" },
      { name: "M", price: 249, originalPrice: 549, sizeType: "standard" },
      { name: "L", price: 299, originalPrice: 599, sizeType: "standard" },
    ],
  },
  {
    ...
    sizeData: [{ name: "R", price: 199, originalPrice: 399 }],
  },
  {
    ...
    sizeData: [{ name: "R", price: 249, originalPrice: 499 }],
  },
  {
    ...
    sizeData: [{ name: "R", price: 129, originalPrice: 249 }],
  },
  {
  ...
  },
  {
    ...
    sizeData: [{ name: "R", price: 119, originalPrice: 249 }],
  },
  {
    ...
    sizeData: [{ name: "R", price: 119, originalPrice: 199 }],
  },
  {
    ...
    sizeData: [
      { name: "R", price: 149, originalPrice: 299, sizeType: "standard" },
    ],
  },
  {
    ...
    sizeData: [
      { name: "R", price: 119, originalPrice: 149, sizeType: "standard" },
    ],
  },
  {
    ...
    sizeData: [{ name: "R", price: 749, originalPrice: 1499 }],
  },
  {
  ...
  },
  {
    ...
    colorData: [{ name: "Black", hexCode: "#000000" }],
    sizeData: [
      { name: "Single", price: 999, originalPrice: 1999 },
      { name: "3 Pack", price: 2499, originalPrice: 4999 },
    ],
  },
  {
    name: "Short Ghost",
  ...
  },
  {
    ...
    sizeData: [{ name: "R", price: 599, originalPrice: 1200 }],
  },
  {
    ...
    sizeData: [{ name: "R", price: 2999, originalPrice: 4999 }],
  },
  {
    name: "Laughing Baba",
    price: 249,
  ...
  },
  {
    ...
    sizeData: [{ name: "R", price: 699, originalPrice: 1199 }],
  },
  {
    ...
    sizeData: [
      { name: "S", price: 249, originalPrice: 499 },
      { name: "M", price: 299, originalPrice: 549 },
      { name: "L", price: 349, originalPrice: 599 },
    ],
  },
  {
    name: "Kaws",
    ...
    sizeData: [
      { name: "S", price: 199, originalPrice: 299 },
      { name: "M", price: 249, originalPrice: 349 },
      { name: "L", price: 299, originalPrice: 399 },
    ],
  },
  {
    name: "Goofy Figurine",
  ...
  },
  {
    ...
    category: "accessories",
    colorData: [{ name: "Gold", hexCode: "#FFD700" }],
    sizeData: [{ name: "R", price: 999, originalPrice: 1999 }],
  },
  {
...

  {
    ...
    sizeData: [{ name: "Set of 2", price: 6999, originalPrice: 9999 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "One Size", price: 1999, originalPrice: 3499 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "One Size", price: 3999, originalPrice: 6499 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "Standard", price: 1999, originalPrice: 3499 }],
    features: [
  ...
  // 🦸‍♂️ Superheroes & Anime Characters - Anime
  {
    ...
    sizeData: [{ name: "Standard", price: 499, originalPrice: 799 }],
    features: [
...

  {
    ...
    sizeData: [{ name: "Standard", price: 2499, originalPrice: 3999 }],
    features: [
...

  {
    ...
    sizeData: [{ name: "R", price: 6699, originalPrice: 9999 }],
    features: [
...

  {
    ...
    sizeData: [{ name: "Standard", price: 1499, originalPrice: 2499 }],
    features: [
  ...
  // 🖊️ Office & Desk Accessories
  {
    ...
    sizeData: [{ name: "Standard", price: 799, originalPrice: 1299 }],
    features: [
...

  {
    ...
    sizeData: [{ name: "One Size", price: 3499, originalPrice: 5499 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "One Size", price: 3999, originalPrice: 5999 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [
      { name: "Universal Adult Fit", price: 3999, originalPrice: 5999 },
    ],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "40 cm x 30 cm", price: 1999, originalPrice: 3499 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "15 cm x 10 cm", price: 999, originalPrice: 1499 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "8 cm x 6 cm", price: 799, originalPrice: 1299 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "25 cm x 10 cm", price: 1199, originalPrice: 1999 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "20 cm x 8 cm", price: 1999, originalPrice: 3499 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "6 cm x 2 cm", price: 599, originalPrice: 999 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "6 cm x 3 cm", price: 499, originalPrice: 799 }],
    features: [
  ...
  },
  {
    ...
    originalPrice: 1199,
    images: [
      "/filaments/product_images/renamedprod/pencilholder/1.png",
      "/filaments/product_images/renamedprod/pencilholder/2.png",
      "/filaments/product_images/renamedprod/pencilholder/3.png",
    ],
    description:
    ...
    sizeData: [{ name: "10 cm x 10 cm", price: 699, originalPrice: 1199 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "5 cm x 3 cm", price: 499, originalPrice: 799 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "12 cm x 10 cm", price: 1299, originalPrice: 2199 }],
    features: [
  ...
  },
  {
    ...
    sizeData: [{ name: "10 cm x 10 cm", price: 1299, originalPrice: 1999 }],
    features: [
  ...
  },
  {
    ...
    category: "Cosplay",
    colorData: [{ name: "Standard", hexCode: "#FFFFFF" }],
    sizeData: [{ name: "R", price: 3499, originalPrice: 9999 }],
    features: [
  ...
  },
  {
    ...
    description:
      "Inspired by Zenitsu Agatsuma's Thunder Breathing Technique, this Nichirin Katana Replica features a yellow lightning-patterned blade, a white and gold-wrapped tsuka (handle), and a detailed tsuba (guard)[cite: 36]. Made for cosplayers and Demon Slayer fans, this sword brings authenticity and high-quality craftsmanship to your collection! [cite: 37]",
    isCustomizable: false,
    category: "Figurine",
    colorData: [{ name: "Standard", hexCode: "#FFFFFF" }],
    sizeData: [{ name: "R", price: 6699, originalPrice: 9999 }],
...
const products = [
  ...
  // ... Add all other Nylon products here
];
