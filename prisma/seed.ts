...
const prebuiltProducts = [
  ...
  },
  {
    ...
    productDetails: ["Dimensions: 5 cm x 5 cm", "Keyring attachment included"],
    highlighted: false,
    productdesc:
  ...
  },
  {
    ...
    sizeData: [
      { name: "R", price: 9999, originalPrice: 9999, sizeType: "standard" },
    ],
  },
  {
    name: "Moon Lamp",
  ...
  },
  {
    ...
    sizeData: [
      { name: "S", price: 9999, originalPrice: 9999, sizeType: "standard" },
      { name: "M", price: 9999, originalPrice: 9999, sizeType: "standard" },
      { name: "L", price: 9999, originalPrice: 9999, sizeType: "standard" },
    ],
  },
  {
...
async function main() {
  for (const product of prebuiltProducts) {
    ...
    await prisma.prebuiltProduct.create({
      data: {
        ...productData,
        id: randomUUID(),
        ...
        sizes: {
          create: sizeData.map((size) => ({
            ...
            originalPrice:
              typeof size.originalPrice === "number" ? size.originalPrice : 0,
          })),
        },
      },
    });
  ...
  const blogs = [
    {
      title:
        "3D Printing in Education: Inspiring the Next Generation of Makers",
